...
/**
 *  Factory that creates a modified `take` effect for filtering out foreign local actions, i.e. actions with a different namespace,
...
const createTakeLocalSaga = ns => {
  return actionType => call(function* () {
    while (true) {
